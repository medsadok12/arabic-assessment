...
function smartReply(msg) {
  ...
  // Generic warm response for unrecognized questions
  return 'سؤال رائع يا صديقي! فهيم يحتاج مفتاح ذكاء اصطناعي حقيقي لأجيبك بأفضل إجابة. اطلب من مشرف الأكاديمية إعداد مفتاح ANTHROPIC_API_KEY أو GEMINI_API_KEY لكي يعمل فهيم بكامل طاقته!';
}
