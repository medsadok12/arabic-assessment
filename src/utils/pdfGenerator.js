...
export async function generateAssessmentPDF(studentInfo, scores, finalLevel) {
  ...
  el.innerHTML = `
    <div style="background:linear-gradient(135deg,#1a237e 0%,#283593 100%);color:white;padding:36px 44px;text-align:center;">
      <div style="font-size:50px;margin-bottom:10px;">🎓</div>
      <h1 style="margin:0 0 6px;font-size:26px;font-weight:900;">تقرير التقييم الشامل</h1>
      <p style="margin:0;opacity:0.9;font-size:15px;">نظام التقييم الذكي — أكاديمية عارم</p>
    </div>
    ...
    <div style="padding:32px 44px;">
      ...
      <div style="display:flex;gap:20px;margin-bottom:28px;">
        <div style="flex:1.5;background:#f5f7fa;padding:22px;border-radius:12px;">
          <h3 style="color:#1a237e;margin:0 0 14px;font-size:15px;padding-bottom:8px;border-bottom:2px solid #e0e0e0;">
            معلومات الطالب
          </h3>
        ...
        <div style="flex:1;background:#1a237e;color:white;padding:22px;border-radius:12px;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;">
      ...
      <div style="margin-bottom:26px;">
        <h3 style="color:#1a237e;margin:0 0 16px;font-size:15px;padding-bottom:8px;border-bottom:2px solid #e0e0e0;">
          تفاصيل المهارات
        </h3>
        ${skillsHTML}
      </div>
