...
export const questionsBank = {
  ...
  level2: {
    listening: [
      {
        id: 'L2_1',
        text: 'استمعتَ: سارة تلميذة مجتهدة، تراجع دروسها كل يوم بعد المدرسة. ما الفكرة الرئيسية؟',
        options: [
      ...
      {
        id: 'L2_2',
        text: 'استمعتَ: والد سارة يبني المباني الكبيرة في المدينة. ما مهنته؟',
        options: [
      ...
      {
        id: 'L2_3',
        text: 'استمعتَ: قال يوسف: "انظري يا سارة! السماء مليئة بغيوم داكنة." ما توقعك للطقس؟',
        options: [
      ...
      {
        id: 'L2_4',
        text: 'استمعتَ: معلمة سارة تشرح الدرس بابتسامة وتساعد كل طالب. ما مهنتها؟',
        options: [
  ...
  level3: {
    listening: [
      {
        id: 'L3_1',
        text: 'استمعتَ: زارت سارة ويوسف مع مدرستهما مزرعة في الريف، وشاهدا كيف تُحلَب الأبقار وتُجمَع البيوض. ما الوصف الأنسب لهذه الرحلة؟',
        options: [
      ...
      {
        id: 'L3_2',
        text: 'استمعتَ: قال المعلم إن النجاح في المسابقة العلمية يحتاج تدرّباً يومياً لا حفظ المعلومات ليلة الاختبار فقط. ماذا يحتاج النجاح وفق كلامه؟',
        options: [
      ...
      {
        id: 'L3_3',
        text: 'استمعتَ لنقاش بين سارة وصديقتها حول الألعاب الإلكترونية. قالت سارة: "ممتعة، لكن يجب ألا تُلهينا عن اللعب في الخارج مع الأصدقاء." ما موقف سارة؟',
        options: [
      ...
      {
        id: 'L3_4',
        text: 'استمعتَ لنقاش بين لاعبين بعد المباراة: الأول قال إن فريقه خسر بسبب خطأ الحكم، والثاني قال إن فريقه يحتاج تدريباً أكثر. أيّهما أقرب للصواب؟',
        options: [
