  ...
  level1: {
    listening: [
      ...
      },
      {
        id:        'L1_SP1',
        type:      'speaking',
        text:      'اسْتَمِعْ ثُمَّ سَجِّلْ صَوْتَكَ',
        audioText: 'هٰذَا أَبِي',
        prompt:    'استمع جيداً، ثم سجّل صوتك وكرّر الجملة بعدي',
      },
    ],
    reading: [
      {
    ...
    writing: [
      {
        id:   'L1_WR1',
        type: 'photo-writing',
        text: 'انْظُرْ إِلَى يَدِكَ، ثُمَّ اكْتُبْ عَلَى وَرَقَةٍ كَلِمَةَ (يَد) وَلَوِّنْهَا بِلَوْنِكَ المُفَضَّل، ثُمَّ صَوِّرْ وَرَقَتَكَ 📷',
      },
    ],
    grammar: [
      {
        id:     'L1_WO1',
        type:   'word-order',
        text:   'رَتِّبِ الكَلِمَاتِ لِتُكَوِّنَ جُمْلَةً صَحِيحَةً',
        words:  ['أُمِّي', 'تَطْبُخُ', 'الطَّعَامَ'],
        answer: ['أُمِّي', 'تَطْبُخُ', 'الطَّعَامَ'],
      },
      {
        id:             'L1_CO1',
        type:           'correction',
        text:           'اقْرَأِ الجُمْلَةَ الخَاطِئَةَ، ثُمَّ اكْتُبْهَا صَحِيحَةً',
        wrongSentence:  'البِنْتُ يَلْعَبُ',
        correctAnswers: ['البِنْتُ تَلْعَبُ'],
        hint:           'البِنْتُ أُنْثَى 👧',
      },
    ],
    vocabulary: [
      {
        id:       'L1_FL1',
        type:     'fill',
        text:     'أَكْمِلِ الجُمْلَةَ بِالكَلِمَةِ المُنَاسِبَةِ',
        sentence: 'أَنَا أَسْمَعُ بِأُذُنِي، وَأَرَى بِـ _____',
        answers:  ['عَيْنِي', 'العَيْن'],
      },
    ],
  },
  ...
  level2: {
    listening: [
      ...
      },
      {
        id:        'L2_5',
        type:      'speaking',
        text:      'استمع للسؤال، ثم سجّل إجابتك بصوتك',
        audioText: 'ماذا تفعل صباحاً قبل الذهاب إلى المدرسة؟',
        prompt:    'استمع جيداً، ثم سجّل صوتك وأجب: ماذا تفعل صباحاً؟',
      },
      {
        id:        'L2_6',
        type:      'speaking',
        text:      'استمع للقصة القصيرة، ثم سجّل صوتك وأجب',
        audioText: 'صديقي أحمد نسي كتابه في البيت اليوم. لماذا شعر أحمد بالحزن؟',
        prompt:    'حاول أن تجيب بجملة كاملة: لماذا شعر أحمد بالحزن؟',
      },
    ],
    vocabulary: [
      {
      ...
      },
      {
        ...
        sentence: 'في المساء أنا _____ واجبي',
        answers:  ['أكتب'],
      },
      {
        id:       'V2_6',
    ...
    grammar: [
      ...
      },
      {
        id:     'G2_5',
        type:   'word-order',
        text:   'رتّب الكلمات لتكوّن جملة صحيحة',
        words:  ['أغسل', 'وجهي', 'في', 'الصباح'],
        answer: ['أغسل', 'وجهي', 'في', 'الصباح'],
      },
      {
        id:     'G2_6',
        type:   'word-order',
        text:   'رتّب الكلمات لتكوّن جملة صحيحة',
        words:  ['أذهب', 'إلى', 'المدرسة', 'كل', 'صباح'],
        answer: ['أذهب', 'إلى', 'المدرسة', 'كل', 'صباح'],
      },
      {
        id:             'G2_7',
        type:           'correction',
        text:           'اقرأ الجملة الخاطئة، ثم اكتبها صحيحة',
        wrongSentence:  'إخوتي يلعب',
        correctAnswers: ['إخوتي يلعبون'],
        hint:           'كم عدد الإخوة؟ الفعل يحتاج للجمع',
      },
      {
        id:             'G2_8',
        type:           'correction',
        text:           'اقرأ الجملة الخاطئة، ثم اكتبها صحيحة',
        wrongSentence:  'أذهب المدرسة',
        correctAnswers: ['أذهب إلى المدرسة'],
        hint:           'نحتاج كلمة تربط بين الفعل والمكان',
      },
    ],
    writing: [
      {
      ...
      },
      {
        id:   'W2_5',
        type: 'photo-writing',
        text: 'اكتب على ورقة أسماء 3 من أفراد عائلتك (مثل: أمي، أخي، جدّتي)، ثم صوّر ورقتك',
      },
      {
        id:   'W2_6',
        type: 'photo-writing',
        text: 'اكتب جملة واحدة تصف فيها ماذا تفعل بعد العودة من المدرسة (مثال: بعد المدرسة آكل وألعب)، ثم صوّر ورقتك',
      },
    ],
  },
