...
const PINNED = new Set(['letter-recognition', 'vowel-cards', 'vowel-long', 'sukun-cards', 'matching', 'speaking', 'photo-writing', 'word-order', 'correction', 'fill']);
...
function buildLevelData(levelId) {
  ...
  return { questions: [...letterRec, ...vowelCards, ...vowelLong, ...sukunCards, ...matching, ...speaking, ...photoWr, ...newTypes, ...regular], answers: [] };
}
