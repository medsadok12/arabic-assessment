...
const PINNED = new Set(['letter-recognition', 'vowel-cards', 'vowel-long', 'matching', 'speaking', 'photo-writing', 'word-order', 'correction', 'fill']);
...
function buildLevelData(levelId) {
  ...
  return { questions: [...letterRec, ...vowelCards, ...vowelLong, ...matching, ...speaking, ...photoWr, ...newTypes, ...regular], answers: [] };
}
