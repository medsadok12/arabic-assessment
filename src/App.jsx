...
const PINNED = new Set(['letter-recognition', 'vowel-cards', 'matching', 'speaking', 'photo-writing', 'word-order', 'correction', 'fill']);
...
function buildLevelData(levelId) {
  ...
  return { questions: [...letterRec, ...vowelCards, ...matching, ...speaking, ...photoWr, ...newTypes, ...regular], answers: [] };
}
